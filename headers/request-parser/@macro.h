...
#else
#if ((long long)RANHTTP_REQUEST_READER_BUFFER_SIZE) < 0 || ((long long)RANHTTP_REQUEST_READER_BUFFER_SIZE) > INT_MAX
#error "macro RANHTTP_REQUEST_READER_BUFFER_SIZE must be greater than 0 and less than or equal to INT_MAX"
#endif // ((long long)RANHTTP_REQUEST_READER_BUFFER_SIZE) < 0 || ((long long)RANHTTP_REQUEST_READER_BUFFER_SIZE) > INT_MAX
